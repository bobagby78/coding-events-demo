...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        if (errors.hasErrors()){
            model.addAttribute("title", "Register");
            errors.rejectValue("username", "username.alreadyExists", "Recheck username and password.");
            return "register";
        }
        ...
        if (!verifyPassword.equals(password)){
            errors.rejectValue("password", "password.mismatch", "Recheck username and password.");
            model.addAttribute("title", "Register");
            return "register";
        }
